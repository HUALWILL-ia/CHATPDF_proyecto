...
Este es un prototipo experimental para validar hipótesis de investigación. Las contribuciones son bienvenidas, especialmente en:

- Estrategias de chunking alternativas
- Algoritmos de fusión de rankings
- Prompts engineering para anti-alucinación
...
Prototipo desarrollado para validación de hipótesis de sistema RAG avanzado.

---

**Nota:** Este sistema está diseñado para fines educativos y de investigación. Para uso en producción, se recomienda implementar manejo robusto de errores, caching, rate limiting y monitoreo.
